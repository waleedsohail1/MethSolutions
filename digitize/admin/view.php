                            ...
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            <li class="list-inline-item active">
                                                <h1>
                                                User ID:&nbsp;      <?php 
                                          $string = file_get_contents("http://18.219.43.174:3000/api/userData/".$_GET['id']);
                                    ...
                                    <button class="au-btn au-btn-icon au-btn--green">
                                        <a href="./index.php"><div style="color:white"><i class="zmdi zmdi-arrow-left"></i>Back</div></a></button>
            ...
            <section class="main">
                <div class="section__content section__content--p30">
                    <div class="container-fluid"><br>
                        ...
                        <button class="au-btn au-btn-icon au-btn--green" style="margin:auto;display:block;">
                                        <a href="./editUser.php?id=<?php echo $_GET['id'];?>"><div style="color:white"><i class="zmdi zmdi-edit"></i> Edit</div></a></button>
                                        <br>
